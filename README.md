...
measured on the fresh scaffold: cold ≈ 85 s (real cargo check + the chromium e2e lane),
warm ≈ 6 s for all 22 steps. Absolute wall-clock UX budgets (TTI, arrow-key latency,
